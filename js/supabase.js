...
// Credentials injected at build time via js/config.js (generated by build.js from Vercel env vars)
// Never hardcode keys here — set SUPABASE_URL and SUPABASE_ANON_KEY in Vercel Dashboard → Settings → Environment Variables
